...
const HorizontalScrollCarousel = () => {
  ...
  const x = useTransform(scrollYProgress, [0, 1], ['0%', '-40.66%']);
        ...
        <motion.div style={{ x }} className="flex w-[300vw] flex-col items-center">
          ...
          <div className="flex w-[300vw]">
            <div className=" w-[300vw] h-[100vh] p-24 flex flex-row relative">
              ...
              {/* Earth info B */}
                ...
                <div className="flex flex-row w-[30vw] items-center">
                  <motion.div style={{ y: yEarthB }}>
                    <img src={Earth} className="h-[400px] w-[400px] ml-12" />
                  </motion.div>
                </div>
                <motion.div
              ...
              {/* Earth info C */}
                            <div className="h-[80vh] w-[40vw] ml-12">
              ...
              {/* Earth info D */}
              <div className="absolute bottom-[30vh] left-[200vw] flex flex-row w-[70vw] items-center">
                <motion.div style={{ y: yEarthB }}>
