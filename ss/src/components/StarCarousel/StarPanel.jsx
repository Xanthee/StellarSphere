...
export default function StarPanel() {
  ...
  if (!clicked) {
    ...
    return (
      <div className="w-full h-screen bg-black text-white flex flex-col items-left justify-center relative">
        ...
        <div className="flex flex-col h-[50vh] w-[40vw] ml-[10vw] absolute z-10">
          <ScrambledText
            className="font-orbitron text-6xl font-extrabold uppercase text-white z-10 drop-shadow-[0px_0px_34px_rgba(223,209,255,1)]"
            text="Journey through the infinite cosmos"
          />
          <ScrambledText
            className="font-mono text-4xl text-white opacity-60 z-10 drop-shadow-[0px_0px_34px_rgba(223,209,255,1)]"
            text="Unveiling the Brilliance of the Night Sky"
          />
          <button
