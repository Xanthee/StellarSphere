...
const App = () => {
  ...
  // Show loader for 4 seconds on first load
  useEffect(() => {
    setLoading(true);
    ...
    <div className="bg-black m-0 p-0">
      ...
      {loading ? (
        <div className="h-screen flex justify-center items-center">
          <RingLoader color={'#3e799c'} loading={loading} size={150} />
        </div>
      ) : (
        <>
          ...
          <div className="h-[100vh] m-0 p-0">
            <div className="relative flex-1 flex items-center justify-center">
              ...
              />
              <a href="#planets" className="text-white font-mono absolute top-[90vh] z-10 rounded-full border border-white bg-transparent text-white px-4 py-2 hover:bg-white hover:text-black transition">
                View the Universe
              </a>
            </div>
          </div>
